...
About Cochrane translations
	
Log inCochrane Library
About us
...
Breadcrumb
Home  For authors  Handbooks and manuals  Cochrane Handbook for Systematic Reviews of Interventions  Current version 
...
           4.S1 Supplementary material: Technical supplement
...
           20.S Technical Supplement: Integrated full systematic review of economic evidence
...
14.1 ‘Summary of findings’ tables#section-14-1
14.1.1 Introduction to ‘Summary of findings’ tables#section-14-1-1
...
14.1.2 Selecting outcomes for ‘Summary of findings’ tables#section-14-1-2
...
14.1.3 General template for ‘Summary of findings’ tables#section-14-1-3
...
Symptomatic deep vein thrombosis (DVT)	See comment	See comment	Not estimable	
...
Symptomless DVT	Low risk populationb	
...
Superficial vein thrombosis	13 per 1000	
...
Lowd
	...
	 
Pulmonary embolus	See comment	See comment	Not estimable	

2821

(9 studies)

	See comment	0 participants developed pulmonary embolus in these studiese
...
(9 studies)
	...
	See comment	0 participants died in these studies
Adverse effects	See comment	See comment	Not estimable	

1182

(4 studies)

	See comment	The tolerability of the stockings was described as very good with no complaints of side effects in 4 studiesf
...
h Serious unexplained inconsistency (large heterogeneity I2 = 79%, P value [P = 0.04], point estimates and confidence intervals vary considerably).

i Serious imprecision. The upper bound of 0.02 fewer days of diarrhoea is not considered patient important.

j Serious unexplained inconsistency (large heterogeneity I2 = 78%, P value [P = 0.05], point estimates and confidence intervals vary considerably).
...
14.1.4 Producing ‘Summary of findings’ tables#section-14-1-4
...
14.1.5 Statistical considerations in ‘Summary of findings’ tables#section-14-1-5
14.1.5.1 Dichotomous outcomes#section-14-1-5-1
...
14.1.5.2 Time-to-event outcomes#section-14-1-5-2
...
14.1.6 Detailed contents of a ‘Summary of findings’ table#section-14-1-6
14.1.6.1 Table title and header#section-14-1-6-1
...
14.1.6.2 Outcomes#section-14-1-6-2
...
14.1.6.3 Best estimate of risk with comparator intervention#section-14-1-6-3
...
14.1.6.4 Risk with intervention#section-14-1-6-4
...
14.1.6.5 Risk difference#section-14-1-6-5
...
14.1.6.6 Relative effect (95% CI)#section-14-1-6-6
...
14.1.6.7 Number of participants (studies)#section-14-1-6-7
...
14.1.6.8 Certainty of the evidence (GRADE)#section-14-1-6-8
...
14.1.6.9 Comments#section-14-1-6-9
...
14.1.6.10 Explanations#section-14-1-6-10
...
Enter the information for readers directly into the table if possible (e.g. information about the duration of follow-up or the scale used).
Generally, do not cite references in the explanations section, unless there are specific reasons, for example, for providing information about sources of baseline risks (see point 3).
Provide the source of information about the baseline risks used to calculate absolute effects.
On completion of the table, review all explanations to determine if some could be referenced multiple times if reworded or combined.
Provide reasons for upgrading and downgrading the evidence (see domain-specific guidance below) and use GRADEpro GDT software to adhere to GRADE guidance.
The body of evidence for a particular outcome may be determined to have serious or very serious issues for the affected domain (or critically serious for risk of bias when ROBINS-I is used). Thus, it may be useful to indicate the number of levels for downgrading (e.g. downgraded by one level for risk of bias), but avoid repetition of what is in the table (and the impression of formulaic or algorithmic reporting). In evidence profiles, this information is already in the cells of the table.
Although explanations about the certainty in the evidence are primarily required when they alter the certainty, consider adding an explanation when the certainty in the evidence has not been altered but when this decision may be questioned by others. This will help with understanding reasons for disagreement.
Ensure that the table is not used as a description of the methods of the review (e.g. do not describe the reasons for the statistical analysis).
...
Use the information presented in the explanations about the GRADE process to inform other key parts of the review, including summary versions and the discussion.
...
Describe the number of studies, or the amount of information that they provide in the meta-analysis, that were at high risk of bias and for which criterion.
Use terms such as majority, minority, all, some or none; or the number of studies as X/X studies.
For randomized trials, mention the specific criteria including allocation sequence concealment, selective outcome reporting, etc. For non-randomized studies, describe the criterion in the tool used (e.g. using the ROBINS-I tool).
Indicate if the effect of the risk of bias was examined in a sensitivity analysis. When appropriate, mention the contribution of the studies at high risk of bias to the estimates.
Information about study design may be included in the explanations, in particular, in SoF when different study designs are included.



Inconsistency

Indicate the measure used to judge inconsistency, such as the statistical test or measure (I2, Chi2, Tau), or the overlap of confidence intervals, or similarity of point estimates.
If inconsistency is based on I2, describe it as considerable, substantial, moderate or not important.
If applicable, mention if heterogeneity was explored in subgroup analyses by PICO (patients, intervention, comparison, outcome), and if there are other potential reasons for the heterogeneity.
In the case of a single study for an outcome, say that there is ‘none’ rather than ‘not applicable’.



Imprecision

Indicate where the sample size or number of events does not meet the optimal information size as calculated, or the ‘rules of thumb’ (e.g. 400 events). Avoid reference to the number of studies as a reason for imprecision.
Indicate whether the confidence intervals include the possibility of a small or no effect AND important benefit or harm. If known, provide the numerical value of the threshold of important benefit.
Avoid reporting the result as statistically or non-statistically significant.



Upgrading

Mention the reason for upgrading: due to large effect; a dose-response gradient; or plausible residual opposing confounding increases the certainty of evidence.
For large effects, report if the relative effect is >2 or >5. For dose-response gradients, provide the level of intervention and effect on the outcome. For the domain ‘plausible residual opposing confounding’, describe the effect of the confounding factor on the estimate.
14.2 Assessing the certainty or quality of a body of evidence#section-14-2
14.2.1 The GRADE approach#section-14-2-1
...
Justify and document all assessments of the certainty of the body of evidence (e.g. downgrading or upgrading using GRADE).	The adoption of a structured approach ensures transparency in formulating an interpretation of the evidence, and the result is more informative to the user.
...
Lower if	Higher if*
Randomized trials or studies evaluated with ROBINS-I	High
certainty	
...
Observational studies not using ROBINS-I	Low
certainty	
...
14.2.2 Domains that can lead to decreasing the certainty level of a body of evidence#section-14-2-2
...
Description (evidence found and included, including evidence from other studies) – consider the domains of study design and study limitation, inconsistency, imprecision and publication bias
...
14.2.3 Domains that may lead to increasing the certainty level of a body of evidence#section-14-2-3
...
14.3 Describing the assessment of the certainty of a body of evidence using the GRADE framework#section-14-3
...
Inconsistency	Describe the degree of inconsistency by outcome using one or more indicators (e.g. I2 and P value), confidence interval overlap, difference in point estimate, between-study variance.	Not downgraded because the proportion of the variability in effect estimates that is due to true heterogeneity rather than chance is not important (I2 = 0%).
...
Publication bias	Describe the possible degree of publication bias.	
...
Large effects (upgrading)	Describe the magnitude of the effect and the widths of the associate confidence intervals.	Upgraded because the RR is large: 0.3 (95% CI 0.2 to 0.4), with a sufficient number of events to be precise.
...
14.4 Chapter information#section-14-4
