...
If a study's line crosses the vertical line, it's not statistically significant on its own.`,
  ...
  // Step 4: Quiz - Components
  {
    ...
    type: 'quiz',
    quizOptions: [
      { text: 'The statistical significance of the study', isCorrect: false },
      { text: 'The weight/precision of the study', isCorrect: true },
      { text: 'The number of participants', isCorrect: false },
      { text: 'The year the study was published', isCorrect: false },
    ],
  },
...
An Odds Ratio < 1 means the treatment (BCG) reduces the outcome (TB).`,
  ...
  // Step 8: Quiz - Interpretation
  {
    ...
    type: 'quiz',
    quizOptions: [
      { text: 'BCG has no effect on TB prevention', isCorrect: false },
      { text: 'BCG appears to reduce TB risk, but effects vary between studies', isCorrect: true },
      { text: 'BCG increases TB risk', isCorrect: false },
      { text: 'We cannot draw any conclusions', isCorrect: false },
    ],
  },
...
But remember: with high heterogeneity, this average might not apply equally everywhere.`,
  ...
  // Step 11: Final Quiz
  {
    ...
    type: 'quiz',
    quizOptions: [
      { text: 'The study found a significant effect', isCorrect: false },
      { text: 'The study is poorly designed', isCorrect: false },
      { text: 'The study alone cannot rule out no effect', isCorrect: true },
      { text: 'The study should be excluded from the meta-analysis', isCorrect: false },
    ],
  },
